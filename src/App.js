    ...
    <header className="App-header">
        ...
        <div className="Top-Banner">
          <div className="Text-Banner">
            ...
            <a target="_blank" className="links" rel="noreferrer" href="https://api.whatsapp.com/send?phone=5511933136789&text=Olá!%20Gostaria%20de%20mais%20informações%20sobre%20o%20empreendimento%20Vivaz%20Belem%20que%20encontrei%20no%20site."><button className="btnSabia" >SABIA MAIS</button></a>
          </div>
        </div>
        <div className="Menu-Icons">
          <img src={capaLocal} className="ImgMenuIcons" alt="Capa do empreendimento" />
          <div className="MenuText">
            <h2 style={{ color: '#2fdada', fontWeight: 'bold' }}>VIVAZ - ESTAÇÃO BELÉM</h2>
      ...
      <div className="Plantas-Apto">
        <h2 className="titleLocal">PLANTAS</h2>
